    ...
    <Box sx={{ flexGrow: 1 }} className="py-[2.4rem] px-[.5rem] bg-white">
      <Grid container spacing={1}>
        <Grid item xs={12} lg={3}>
          <div className=" mb-16 flex justify-center items-center lg:items-start flex-col ">
          ...
          <div className="w-full flex">
            <div className="flex flex-col lg:w-[95%] w-full rounded-sm p-4 border-gray-300 border ">
